...
const handlers: ProxyHandler<any> = {
  ...
  set (target, p, v, r) {
    ...
    /* istanbul ignore next */ if (re) {
      if (target[PROXY]) target[PROXY][p] = undefined
      target[ON_CHANGE](target)
    }
    return re
  },
...
export const newInstance: (...stores: Array<Store | typeof Store>) => React.FC & {
  getStore: GetStore
  patch: () => void
  addStores: (...stores: Array<Store | typeof Store>) => void
} = function () {
